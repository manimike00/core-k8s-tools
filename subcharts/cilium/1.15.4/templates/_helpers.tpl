...
{{- else if and $root.Values.enableCriticalPriorityClass $criticalPriorityClass -}}
  {{- if and (eq $root.Values.Namespace "kube-system") (semverCompare ">=1.10-0" $root.Capabilities.KubeVersion.Version) -}}
...
{{- define "cilium.ca.setup" }}
  {{- if not .commonCA -}}
    ...
    {{- else }}
      {{- with lookup "v1" "Secret" .Values.Namespace $secretName }}
